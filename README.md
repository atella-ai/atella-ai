...
> **[clawbot voice-agent](https://github.com/atella-ai/clawbot)** — AI-powered voice agent that makes real outbound phone calls on your behalf. Integrates with OpenClaw as an orchestrated skill — users request calls via Slack, the agent dials, converses naturally, and returns a summary. Deployed on AWS with ACP-compatible API.
